...
>>>>>>> da4658ee8c760877b425702f6377d485e32fc78f
        }
    ...
    private string retrieveEmailID()
    {
        ...
        string cmd1 = "SELECT emailID FROM ProjectSettings.schema.REGISTEREDUSER WHERE username = '" + Context.User.Identity.Name + "'";
