...
public partial class Account_Restaurants : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["restaurant"] != null)
        {
            ...
            string cmd = "SELECT NAME, DESCRIPTION, OPENTIME, CLOSETIME,ADDRESS1, ADDRESS2, CITY, STATE, ZIP, RESTAURANTID,NONWORKINGDAYS, PRIVATEDINING FROM SRAJAGOP.RESTAURANT WHERE RESTAURANTID = " + rid;
